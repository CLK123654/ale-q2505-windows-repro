...
def main()->None:
 ...
 if c.returncode or "maxReplicas: 32" not in (positive/"output/evidence/rendered.yaml").read_text(encoding="utf-8"):raise AssertionError("valid policy change had no effect")
